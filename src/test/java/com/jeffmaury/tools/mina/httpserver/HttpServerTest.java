...
import com.jeffmaury.tools.mina.httpserver.HttpServer;
import com.jeffmaury.tools.mina.httpserver.HttpServerConfigurationBuilder;
...
public class HttpServerTest {
  ...
  public static void setUp() throws IOException, IllegalArgumentException, InterruptedException, ExecutionException {
    server = new HttpServer(new HttpServerConfigurationBuilder().baseDir("target/www").build());
    server.start();
